...
VALUES (1, 1, 2, 'CREDIT', 1600.00, 'EUR', 'COMPLETED', '2022-06-06 12:00:00', 'transaction 1', '{"sender_amount_before" : "2000", "receiver_amount_before" : "0", "sender_amount_after" : "400", "receiver_amount_after" : "1600"}'::jsonb),
       (2, 6, 3, 'CREDIT', 9200.00, 'EUR', 'COMPLETED', '2022-07-10 15:00:00', 'transaction 2', '{"sender_amount_before" : "9200", "receiver_amount_before" : "10000", "sender_amount_after" : "0", "receiver_amount_after" : "19200"}'::jsonb),
       (3, 2, 1, 'CREDIT', 600.99, 'EUR', 'UNPROCESSED', '2022-11-06 18:00:00', 'transaction 3', null::jsonb),
       (4, 1, 7, 'DEBIT', 2000.00, 'EUR', 'UNPROCESSED', '2022-11-06 18:30:00', 'transaction 4', null::jsonb),
       (5, 3, 1, 'CREDIT', 1000.00, 'EUR', 'UNPROCESSED', '2022-12-06 18:00:00', 'transaction 5', null::jsonb),
       (6, 4, 2, 'CREDIT', 300.80, 'EUR', 'UNPROCESSED', '2022-12-06 19:00:00', 'transaction 6', null::jsonb),
       (7, 8, 7, 'DEBIT', 5000.00, 'EUR', 'UNPROCESSED', '2022-12-06 19:00:10', 'transaction 7', null::jsonb);