...
public class MoneyTest {
    ...
    public void isPositive_should_returnFalse_when_balanceValueIsLessToZero() {
        Money money = new Money(BigDecimal.TEN.negate());
        money.isPositive();
    ...
    public void minus_should_subtractAmount_when_AmountIsPositiveAndValueIsPositive() {
        Money moneyOne = new Money(BigDecimal.TEN);
        Money moneyTwo = new Money(BigDecimal.TEN);
    ...
    public void minus_should_additionAmount_when_ValuesIsNegative() {
        Money moneyOne = new Money(BigDecimal.TEN.negate());
        Money moneyTwo = new Money(BigDecimal.TEN.negate());
